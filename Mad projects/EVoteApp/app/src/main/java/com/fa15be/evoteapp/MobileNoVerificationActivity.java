...
//        setContentView(R.layout.activity_main);
        ...
        phoneText = (EditText) findViewById(R.id.MobNoEd);
        codeText = (EditText) findViewById(R.id.codeEdt);
...
//                            statusText.setText("Signed In");
                            ...
                            if (task.getException() instanceof
                                ...
                                Toast.makeText(MobileNoVerificationActivity.this, "Invalid Code", Toast.LENGTH_SHORT).show();
                                codeText.setText("");
                            }
                        }
                    }
